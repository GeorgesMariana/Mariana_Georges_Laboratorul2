...
namespace Mariana_Georges_Laboratorul2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Mariana_Georges_Laboratorul2Context context,Book book)
        {
        ...
        public void UpdateBookCategories(Mariana_Georges_Laboratorul2Context context,
